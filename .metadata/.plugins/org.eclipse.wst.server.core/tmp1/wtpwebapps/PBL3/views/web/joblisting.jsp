...
<body>
	...
	<!-- Hero Area End --> <!-- Job List Area Start -->
					...
					<div class="job-category-listing mb-50">
						...
						<div class="single-listing">
							...
							<div class="select-Categories pt-80 pb-50">
								...
								<label class="container">Full Time <input
						...
						<div class="single-listing">
							...
							<div class="select-Categories pt-80 pb-50">
								...
								<label class="container">1-2 Years <input
									type="checkbox"> <span class="checkmark"></span>
									...
									type="checkbox"> <span class="checkmark"></span>
								</label> <label class="container">6-more.. <input
									type="checkbox"> <span class="checkmark"></span>
								</label>
							</div>
							<!-- select-Categories End -->
						...
						<div class="container">
								...
								<div class="col-lg-12">
									<div class="count-job mb-35">
										...
										<div class="select-job-items">
											<span>Sort by</span> <select name="select">
							...
							<div class="single-job-items mb-30">
								<div class="job-items">
									<div class="company-img">
										<a href="#"><img
											src="${pageContext.request.contextPath}/assets/img/icon/job-list3.png"
											alt=""></a>
									</div>
									<div class="job-tittle job-tittle2">
										<a href="#">
							...
							<div class="single-job-items mb-30">
								<div class="job-items">
									<div class="company-img">
										<a href="#"><img
											src="${pageContext.request.contextPath}/assets/img/icon/job-list4.png"
											alt=""></a>
									</div>
									<div class="job-tittle job-tittle2">
										<a href="#">
