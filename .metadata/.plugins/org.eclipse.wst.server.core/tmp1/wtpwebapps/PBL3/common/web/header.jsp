			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-3 col-md-2">
						<!-- Logo -->
						<div class="logo">
							<a href="index.html"><img src="<c:url value = '/assets/img/logo/logo.png'/>"
								alt=""/></a>
						</div>
					</div>
					<div class="col-lg-9 col-md-9">
						<div class="menu-wrapper">
							...
							<div class="header-btn d-none f-right d-lg-block">
								<a href="${pageContext.request.contextPath}/register" class="btn head-btn1">Register</a> <a href="${pageContext.request.contextPath}/login"
