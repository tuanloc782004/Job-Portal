...
<head>
<meta charset="UTF-8">
<title>Recruiter - Posted Jobs</title>
</head>
<body>
	<form
		action="/PBL3/recruiter-job?locationS=<%=request.getParameter("locationS")%>&typeS=<%=request.getParameter("typeS")%>&categoryS=<%=request.getParameter("categoryS")%>"
		method="get">
		...
		<div class="job-listing-area pt-120 pb-120">
			<div class="container">
				...
				<div class="container text-left">
					<a href="<%=request.getContextPath()%>/recruiter-job-new"
						class="btn btn-success">Post New Job</a>
				</div>
				<hr>
				<br>
				<div class="row">
									...
									<div class="single-job-items mb-30">
										<div class="job-items">
											<div class="company-img">
												<a href="/PBL3/recruiter-resume?id=${job.idRecruiter}"><img
												...
												<div class="row">
													<div class="col-md-4">
														<div class="items-link items-link2 f-left">
															<a href="/PBL3/recruiter-job-applicant?id=${job.id}">Applicant</a>
														</div>
													</div>
													<div class="col-md-4">
														<div class="items-link items-link2 f-left">
															<a href="/PBL3/recruiter-job-edit?id=${job.id}">Edit</a>
														</div>
													</div>
													<div class="col-md-4">
														<div class="items-link items-link2 f-center">
															<a href="/PBL3/recruiter-job-delete?id=${job.id}">Delete</a>
														</div>
													</div>
												</div>
										...
										<div class="items-link items-link2 f-right">
											<a href="/PBL3/recruiter-job-details?id=${job.id}" />
								...
								<ul class="pagination">
									<c:if test="${page > 1}">
										<li class="page-item"><a class="page-link"
											href="/PBL3/recruiter-job?locationS=${param.locationS}&typeS=${param.typeS}&categoryS=${param.categoryS}&page=${page - 1}">Previous</a>
										</li>
									</c:if>
										...
										<c:choose>
											<c:when test="${temp == page}">
												<li class="page-item active"><a class="page-link"
													href="/PBL3/recruiter-job?locationS=${param.locationS}&typeS=${param.typeS}&categoryS=${param.categoryS}&page=${temp}">${temp}</a>
												</li>
											</c:when>
											<c:otherwise>
												<li class="page-item"><a class="page-link"
									...
									<c:if test="${page < totalPage}">
										<li class="page-item"><a class="page-link"
											href="/PBL3/recruiter-job?locationS=${param.locationS}&typeS=${param.typeS}&categoryS=${param.categoryS}&page=${page + 1}">Next</a>
										</li>
									</c:if>
								</ul>
							</nav>
