...
<body>
	<form
		action="/PBL3/user-applied-job?locationS=<%=request.getParameter("locationS")%>&typeS=<%=request.getParameter("typeS")%>&categoryS=<%=request.getParameter("categoryS")%>"
		method="get">
												...
												<div class="row">
													<div class="col-md-4">
														<div class="items-link items-link2 f-left">
															<a href="/PBL3/user-applied-job-delete?id=${job.id}">Cancel</a>
														</div>
													</div>
												</div>
											</div>
								...
								<ul class="pagination">
									<c:if test="${page > 1}">
										<li class="page-item"><a class="page-link"
											href="/PBL3/user-applied-job?locationS=${param.locationS}&typeS=${param.typeS}&categoryS=${param.categoryS}&page=${page - 1}">Previous</a>
										</li>
									</c:if>
										...
										<c:choose>
											<c:when test="${temp == page}">
												<li class="page-item active"><a class="page-link"
													href="/PBL3/user-applied-job?locationS=${param.locationS}&typeS=${param.typeS}&categoryS=${param.categoryS}&page=${temp}">${temp}</a>
												</li>
											</c:when>
											<c:otherwise>
												<li class="page-item"><a class="page-link"
									...
									<c:if test="${page < totalPage}">
										<li class="page-item"><a class="page-link"
											href="/PBL3/user-applied-job?locationS=${param.locationS}&typeS=${param.typeS}&categoryS=${param.categoryS}&page=${page + 1}">Next</a>
										</li>
									</c:if>
								</ul>
							</nav>
